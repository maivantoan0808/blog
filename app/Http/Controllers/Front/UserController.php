...
class UserController extends Controller
{
    ...
    */
    ...
    {
        return $this->repository->avatar($request, $user);
    }
    ...
    public function search(Request $request)
    {
        ...
        {
            $users = User::select('id', 'name', 'email', 'point', 'avatar', 'education')->whereValid(true)->where('role', '!=', 1)->Where('name', 'like', "%$search%")->orwhere('email', 'like', "%$search%")->withCount('follows')->OrderBy('follows_count', 'desc')->get();
        }
