    ...
    @else
            ...
            <li class="nav-item">
                <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#">
                    <img src="/upload/users/{{Auth::user()->avatar}}" class="img-circle elevation-2 img-fluid" alt="User Image" style="width: 30px !important; height: 30px !important; margin-top: -5px;">
                </a>
            </li>
        </ul>
    </nav>
