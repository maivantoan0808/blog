          ...
          <div class="card-outline">
            <div class="card-body p-0">
                <div class="mailbox-read-info">
                    ...
                    <h6 style="margin-top: 10px;"><a href="#" ><img class="img-circle img-sm" src="/upload/users/{{$post->user->avatar}}" alt="User Image" style="margin: -5px 5px 0 0;">  {{ $post->user->name }}</a>
            ...
            <div class="card-footer">
                ...
                @if (Auth::check())
                    <form action="{{ route('posts.comments.store', [$post->id]) }}" method="post">
                        {{ csrf_field() }}
                        <img class="img-fluid img-circle img-sm" src="/upload/users/{{$post->user->avatar}}" alt="Alt Text">
