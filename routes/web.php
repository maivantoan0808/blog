...
Route::group(['middleware' => ['auth']], function () {
    Route::name('posts.like')->put('posts/like/{post}', 'Front\LikeController@like');
});
...
//Change avatar user
Route::name('front.user.avatar')->post('front/user/avatar/{user}', 'Front\UserController@avatar');
